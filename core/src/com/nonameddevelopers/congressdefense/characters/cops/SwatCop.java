...
public class SwatCop extends Cop {
	...
	public SwatCop(CongressDefense game, float x, float y, float xDestino,
		...
		runUlAnimation = loadAnimation("sprites/coprun/up_left.png", 4, 5,
				0.018f);
		runDlAnimation = loadAnimation("sprites/coprun/down_left.png", 4, 5,
				0.018f);
		runUrAnimation = loadAnimation("sprites/coprun/up_right.png", 4, 5,
				0.018f);
	...
	private void goPlace() {
		direction2.set(new Vector2(xDestino, yDestino)).sub(new Vector2(x, y))
				.nor();
		x += direction2.x * 100 * speed;
		y += direction2.y * 100 * speed;// falta el * delta
