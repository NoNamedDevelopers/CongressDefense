...
public class GameScreen implements Screen {
	...
	private void loadMenu() {
		...
		menu.add(new CopIcon(game, camera, 60, camera.position.x+75, 10, "ui/meleecopicon2.png", CopIcon.MELEE));
		menu.add(new CopIcon(game, camera, 180, camera.position.x-5, 10, "ui/bazookacopicon2.png", CopIcon.BAZOOKA));
